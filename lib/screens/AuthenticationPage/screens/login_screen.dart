                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage("asset/icons/auth/login_icon.png"),
                          fit: BoxFit.contain)),
                ),
                SizedBox(
                  height: height * 0.070,
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Expanded(
                            child: TextFormField(
                              controller:
                                  _loginController.loginEmailTextController,
                              validator: (value) {
                  ...
                  onTap: () {
                    if (formKey.currentState!.validate()) {
                      ...
                      _loginController.handleLogin(
                          email: _loginController.loginEmailTextController.text,
                          password:
