              ...
              Container(
                ...
                decoration: const BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage("asset/icons/auth/forgot_password.png"),fit: BoxFit.contain
                    )
                ),
              ),
              SizedBox(height: height * 0.020,),
              Text("Forgot",style: TextStyle(fontSize: height * 0.025,fontWeight: FontWeight.bold),),
              Text("Password?",style: TextStyle(fontSize: height * 0.025,fontWeight: FontWeight.bold),),
              SizedBox(height: height * 0.020,),
              Text("Don't worry! It happens. Please enter the address associated with your account.",style: TextStyle(color: Colors.black.withOpacity(0.8)),),
