              ...
              Container(
                ...
                decoration: const BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage("asset/icons/auth/reset_password.png"),fit: BoxFit.contain
                    )
                ),
              ),
              SizedBox(height: height * 0.020,),
              Text("Reset",style: TextStyle(fontSize: height * 0.025,fontWeight: FontWeight.bold),),
              Text("Password",style: TextStyle(fontSize: height * 0.025,fontWeight: FontWeight.bold),),
                  ...
                  children: <Widget>[
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          child: Obx(()=>TextFormField(
                            ...
                            controller: _loginController.newPasswordTextController,
                            validator: (value){
                              if(value!.isEmpty){
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          child: Obx(()=>TextFormField(
                            controller: _loginController.confirmNewPasswordTextController,
                            obscureText: _loginController.isVisible.value,
                            validator: (value){
                              if(value!.isEmpty){
                                return "Password is required!";
                              }else if(value == _loginController.newPasswordTextController.text){
