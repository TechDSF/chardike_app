...
class AddressController extends GetxController{
  ...
  addAddress({required AddressModel addressModel, required BuildContext context}){
...
class AddressModel{
  ...
  AddressModel({required this.id, required this.fullName, required this.phoneNumber, required this.region, required this.city, required this.area, required this.address, required this.label});
}