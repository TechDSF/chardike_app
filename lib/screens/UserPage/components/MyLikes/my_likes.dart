    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            Obx((){
              if(!_homeController.myLikesProductList.isEmpty){
                return Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      SizedBox(),
                      Image.asset("asset/icons/search_document.png",color: Colors.grey,height: SizeConfig.screenHeight * 0.1,width: double.infinity,),
                      Text("You haven't liked any product yet",style: TextStyle(color: Colors.black),),
                      ElevatedButton(onPressed: (){
                        Navigator.pop(context);
                      }, child: Text("Go Shopping Now"),style: ButtonStyle(
                        backgroundColor: MaterialStateProperty.all<Color>(AllColors.mainColor),
                      ),),
                    ],
                  ),
                );
                ...
                return GridView.builder(
                    ...
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        ...
                        childAspectRatio: aspt(getProportionateScreenHeight(250)),
                            ...
                            Expanded(child: Row(
                              children: <Widget>[
                                Expanded(
                                  child: Column(
                                    children: <Widget>[
                                      Text("Product name",maxLines: 2,style: TextStyle(fontSize: getProportionateScreenHeight(12),overflow: TextOverflow.ellipsis),),
                                      Text(CommonData.takaSign+ " 200",style: TextStyle(fontSize: getProportionateScreenHeight(12),color: AllColors.mainColor),)
                                    ],
