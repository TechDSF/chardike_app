...
class HoldStatus extends StatelessWidget {
  HoldStatus({Key? key}) : super(key: key);
    ...
    return Scaffold(
        ...
        body: Obx(() {
          if (_purchaseController.isOrderStausLoading.value) {
            ...
            if (_purchaseController.statusHoldList.isEmpty) {
              return Column(
              ...
              return ListView.builder(
                  itemCount: _purchaseController.statusHoldList.length,
                  itemBuilder: (context, index) {
                    var result = _purchaseController.statusHoldList[index];
