...
class FailedStatus extends StatelessWidget {
  FailedStatus({Key? key}) : super(key: key);
    ...
    return Scaffold(
        ...
        body: Obx(() {
          if (_purchaseController.isOrderStausLoading.value) {
            ...
            if (_purchaseController.statusFailedList.isEmpty) {
              return Column(
              ...
              return ListView.builder(
                  itemCount: _purchaseController.statusFailedList.length,
                  itemBuilder: (context, index) {
                    var result = _purchaseController.statusFailedList[index];
