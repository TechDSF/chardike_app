...
class OnlyYouDetails extends StatelessWidget {
  OnlyYouDetails({Key? key}) : super(key: key);
          ...
          child: GridView.builder(
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                  ...
                  childAspectRatio: CommonData.aspactRatio(
                      ...
                      crossAxisCount: 2,
                      crossAxisSpacing: 5)),
              itemCount: _homeController.onlyForYouBanner!.products.length,
              itemBuilder: (context, index) {
                ProductModel result = _homeController
                    .onlyForYouBanner!.products[index].bannerProduct!;
                return InkWell(
                  onTap: () {
                                ...
                                Row(
                                  ...
                                  children: [
                                    RatingBarIndicator(
                                      ...
                                      itemCount: 5,
                                      itemSize: SizeConfig.screenWidth * 0.03,
