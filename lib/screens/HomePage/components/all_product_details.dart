    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: <Widget>[
            IconButton(
                onPressed: () {
                  _homeController.isSearchClicked.value =
                      !_homeController.isSearchClicked.value;
                },
                icon: Obx(() => _homeController.isSearchClicked.value
                    ? Icon(Icons.clear)
                    : Icon(Icons.search)))
          ],
        ),
        body: Column(
          children: <Widget>[
            Obx(() {
              if (_homeController.isSearchClicked.value) {
                return Container(
                  ...
                  child: TextField(
                    onChanged: (value) {
                      _homeController.filterAllProduct(value);
                    },
              ...
              () => GridView.builder(
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      childAspectRatio: CommonData.aspactRatio(
                          ...
                          crossAxisCount: 2,
                          crossAxisSpacing: 5)),
                  itemCount: _homeController.allFilterProduct.value.length,
                  itemBuilder: (context, index) {
                    ProductModel result =
                        _homeController.allFilterProduct.value[index];
                    return InkWell(
                      onTap: () {
