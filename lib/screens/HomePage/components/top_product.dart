...
class TopProduct extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        if (_homeController.isTopProductLoading.value) {
          ...
          if (_homeController.topProductList.isEmpty) {
            return Column(
            ...
            return GridView.builder(
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    ...
                    childAspectRatio: CommonData.aspactRatio(
                        ...
                        crossAxisCount: 2,
                        crossAxisSpacing: 5)),
                itemCount: _homeController.topProductList.length,
                itemBuilder: (context, index) {
                  ProductModel result = _homeController.topProductList[index];
                  return InkWell(
                    onTap: () {
